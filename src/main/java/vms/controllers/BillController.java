...
public class BillController implements Serializable {
    ...
    @EJB
    private vms.faces.BillFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, "BillCreated");
    ...
    public void update() {
        persist(PersistAction.UPDATE, ("BillUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ("BillDeleted"));
        if (!JsfUtil.isValidationFailed()) {
